  ...
  render() {
    ...
    return (
      <div className="ScoreTable">
        ...
        <section className="ScoreTable-section ScoreTable-section-lower">
          ...
          <table cellSpacing="0">
            <tbody>
              ...
              <RuleRow name="Large Straight" score={scores.largeStraight} description={smallStraight.description} doScore={evt => doScore("largeStraight", largeStraight.evalRoll)} />
        ...
        <h2>Total scrore: {this.getTotalScore()}</h2>
      </div>
    )
  }
}
